...
const EditAppointment=({clientId,loginDetails,showEditModal,handleClose, updateAppointmentList, appointment,setShowEditModal,setShowDetailsModal})=> {
...
<Form onSubmit={handleSubmit}>
      ...
      <Button onClick={handleCancel} className="mr-4 text-dark bg-gradient-to-tr from-teal-200 to-teal-100 border-white ">Cancel</Button>
